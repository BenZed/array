...
export type IndexValue<A extends ArrayLike<unknown> | array> = A extends
    | Array<infer Vx>
    | Readonly<Array<infer Vx>>
    ? Vx
 ...
 */
export type First<A extends array> = A extends
    | [infer F, ...unknown[]]
    | [infer F]
    ? F
    : unknown
 ...
 */
export type Last<A extends array> = A extends
    | [...unknown[], infer L]
    | [infer L]
    ? L
    : unknown
